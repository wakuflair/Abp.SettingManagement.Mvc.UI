...
namespace Abp.SettingManagement.Mvc.UI.SettingProperties
{
    public class SettingProperty_Tests : AbpSettingManagementMvcUIDomainTestBase
    {
        [Fact]
        public Task BuiltIn_Setting_Properties_Should_Be_Defined()
        {
            ...
            var fileInfo = GetRequiredService<IVirtualFileProvider>().GetFileInfo("/SettingProperties/AbpSettingManagementMvcUISettingProperties.json");
