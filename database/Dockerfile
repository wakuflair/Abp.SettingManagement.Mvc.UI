...
WORKDIR /templates/service/host/Abp.SettingManagement.Mvc.UI.Host
RUN dotnet restore
RUN dotnet ef migrations script -i -o migrations-AbpSettingManagementMvcUI.sql
...
COPY --from=build /templates/service/host/Abp.SettingManagement.Mvc.UI.Host/migrations-AbpSettingManagementMvcUI.sql migrations-AbpSettingManagementMvcUI.sql
